...
const handleCellClick = (columnName: string) => {
  const index = verbsData.value.indexOf(rowData.value);
...
<template>
  <tr class="border-b border-gray-200 dark:border-gray-700">
    <!-- Infinitive cell -->
    <td scope="row" class="py-3 hover:bg-blue-100 dark:hover:bg-gray-600" @click="handleCellClick(Columns.Infinitive)">
      <div class="flex justify-center flex-wrap">
        ...
        <img
          title="Pronunciation"
          :src="selectedColumn === Columns.Infinitive && clickedRowIndex === rowIndex && speaking ? unMutedIcon : mutedIcon"
          alt="Pronunciation"
          width="16"
          height="16"
          class="ml-2 opacity-50 hover:opacity-100 ease-in duration-300 cursor-pointer"
          @click.prevent="
            selectedColumn === Columns.Infinitive && clickedRowIndex === rowIndex && speaking
              ? ''
    ...
    <!-- Past simple cell -->
    <td class="py-3 bg-gray-100 dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-gray-600" @click="handleCellClick(Columns.PastSimple)">
      <div class="flex justify-center flex-wrap">
        <a
        ...
        <img
          title="Pronunciation"
          :src="selectedColumn === Columns.PastSimple && clickedRowIndex === rowIndex && speaking ? unMutedIcon : mutedIcon"
          alt="Pronunciation"
          width="16"
          height="16"
          class="ml-2 opacity-50 hover:opacity-100 ease-in duration-300 cursor-pointer"
          @click.prevent="
            selectedColumn === Columns.PastSimple && clickedRowIndex === rowIndex && speaking
              ? ''
    ...
    <td class="py-3 hover:bg-blue-100 dark:hover:bg-gray-600" @click="handleCellClick(Columns.PastParticiple)">
      <div class="flex justify-center flex-wrap">
        <a
        ...
        <img
          title="Pronunciation"
          :src="selectedColumn === Columns.PastParticiple && clickedRowIndex === rowIndex && speaking ? unMutedIcon : mutedIcon"
          alt="Pronunciation"
          width="16"
          height="16"
          class="ml-2 opacity-50 hover:opacity-100 ease-in duration-300 cursor-pointer"
          @click.prevent="
            selectedColumn === Columns.PastParticiple && clickedRowIndex === rowIndex && speaking
              ? ''
